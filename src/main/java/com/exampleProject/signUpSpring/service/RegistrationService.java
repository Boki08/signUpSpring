...
import com.exampleProject.signUpSpring.domain.AppUserRole;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = appUserService.SignUpUser(new AppUser(request.getFirstName(), request.getLastName(),
                request.getPassword(), request.getEmail(), AppUserRole.USER));

        String link = "http://192.168.0.13:8080/api/registration/confirm?token=" + token;
